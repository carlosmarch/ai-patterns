<!-- GENERATED by scripts/build-skill.mjs from src/registry/access/invite-members/. Do not hand-edit; edit the registry and re-run `npm run skill:build`. -->

**category:** access · **slug:** `invite-members`
