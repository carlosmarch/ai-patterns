...
| slug | title | description | spec |
| --- | --- | --- | --- |
| `tool-approval` | Tool Approval | An inline allow/deny prompt gating a tool call before it runs. | [permissions/tool-approval.md](./permissions/tool-approval.md) |
