...
export const SUGGESTIONS: SessionSuggestion[] = [
  ...
  { id: "collab", label: "Show who's online", icon: Users2 },
  { id: "invite", label: "Invite a teammate", icon: UserPlus },
  { id: "analysis", label: "Scan a list of items", icon: ListChecks },
  { id: "checklist", label: "Walk me through setup", icon: ClipboardList },
  { id: "create-agent", label: "Create a new agent", icon: PlusCircle },
  { id: "agent-triggers", label: "Configure agent triggers", icon: Zap },
  { id: "gen-error", label: "Hit a generation error", icon: CircleAlert },
  { id: "connectivity", label: "Lose your connection", icon: WifiOff },
  { id: "human-in-the-loop", label: "Pause and ask me something", icon: Hand },
];
